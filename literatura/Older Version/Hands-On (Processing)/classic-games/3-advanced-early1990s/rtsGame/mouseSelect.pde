...
// mousePressed and mouseReleased are not explicitly called by our code
// these functions are connected automatically by Processing to when a
// mouse button is first pushed down or just recently let back up
...
// we don't call this code directly - see comment above mousePressed()
