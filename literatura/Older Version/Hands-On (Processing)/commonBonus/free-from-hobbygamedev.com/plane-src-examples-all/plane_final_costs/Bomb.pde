    ...
    if(pos.x < 0 || pos.x >= WORLD_SIZE ||
      ...
      switch(type) {
        ...
        case TYPE_CLUSTER:
          ...
          for(int i=0;i<5;i++) {
            pfx.spawn(pos.x+random(-35,35), pos.y+random(-19,midAirCollision ? -7 : 3.5),Particles.TYPE_GLOW, 4);
            pfx.spawn(pos.x+random(-21,21), pos.y+random(-17,midAirCollision ? -14 : 3.5),Particles.TYPE_SMOKE, 4);
            pfx.spawn(pos.x+random(-25,25), pos.y+random(-10,midAirCollision ? -14 : 3.5),Particles.TYPE_DEBRIS, 3);
            pfx.spawn(pos.x+random(-12,12), pos.y+random(-14,midAirCollision ? -14 : 3.5),Particles.TYPE_LIGHT, 3);
