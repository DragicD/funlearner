class Plane {
  ...
  void handle() {
    ...
    if(alt<0 || midAirCollision) {
      ...
      for(int i=0;i<5;i++) {
        pfx.spawn(pos.x+random(-50,50), pos.y+random(-15,midAirCollision ? -10 :5),Particles.TYPE_GLOW, 4);
        pfx.spawn(pos.x+random(-30,30), pos.y+random(-25,midAirCollision ? -20 :5),Particles.TYPE_SMOKE, 4);
        pfx.spawn(pos.x+random(-35,35), pos.y+random(-15,midAirCollision ? -20 :5),Particles.TYPE_DEBRIS, 3);
        pfx.spawn(pos.x+random(-17,17), pos.y+random(-20,midAirCollision ? -20 : 5),Particles.TYPE_LIGHT, 3);
      ...
      if(midAirCollision) {
        for(int i=0;i<10;i++) {
          pfx.spawn(pos.x+random(-21,21), pos.y+random(0,h-pos.y),Particles.TYPE_SMOKE, 1);
      ...
      for(int i=0;i<8;i++) {
        pfx.spawn(pos.x+random(-28,28), pos.y+random(-10,midAirCollision ? -7 : 3.5),Particles.TYPE_FIRE, 20);
        pfx.spawn(pos.x+random(-35,35), pos.y+random(-10,midAirCollision ? -7 : 3.5),Particles.TYPE_GLOW, 1);
        pfx.spawn(pos.x+random(-21,21), pos.y+random(-17,midAirCollision ? -14 : 3.5),Particles.TYPE_SMOKE, 1);
      }
